...
ifeq ($(shell uname),Darwin)
	JAVA_JNI_DIR = $(shell /usr/libexec/java_home)/include
	...
	LDFLAGS = -L . -L./sdhash-jni/src/main/resources/boost/osx -lboost_system -lboost_filesystem -lboost_program_options -lc -lm -lcrypto -lboost_thread -lpthread -shared -Wl,-install_name,$(SHARED_LIB) -o $(SHARED_LIB)
endif
